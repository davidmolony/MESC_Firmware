...
#ifndef INC_MESC_F411_H_
#define INC_MESC_F411_H_
...
#define LR_OBS_CURRENT 0.1f*MAX_IQ_REQUEST 	//Inject this much current into the d-axis at the slowloop frequency and observe the change in Vd and Vq
