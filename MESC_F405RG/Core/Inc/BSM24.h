...
#define ABS_MAX_PHASE_CURRENT 600.0f //We set this as the board abs max, and the firmware sets the value actually used depending on the input setpoints with this as a maximum.
#define ABS_MAX_BUS_VOLTAGE 110.0f
#define ABS_MIN_BUS_VOLTAGE 40.0f
#define R_SHUNT 1.0f
#define OPGAIN 1.65f/750.0f //680 range measured //340A half range
